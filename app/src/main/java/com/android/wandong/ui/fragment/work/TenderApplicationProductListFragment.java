 ...
 */
public class TenderApplicationProductListFragment extends APullToRefreshListFragment<TenderApplicationProductListFragment.AccountInfo>  {
    ...
    public static void launchForResult(TenderApplicationCreateFragment from, int requestCode) {
        FragmentContainerActivity.launchForResult(from, TenderApplicationProductListFragment.class, null, requestCode);
    }
