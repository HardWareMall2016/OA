 ...
 */
public class EntertainmentApplicationDetailFragment extends ABaseFragment{
    public static void launch(FragmentActivity activity) {
        FragmentArgs args = new FragmentArgs();
        //args.add(ARG_KEY, signId);
        FragmentContainerActivity.launch(activity, EntertainmentApplicationDetailFragment.class, args);
    }
    ...
    protected int inflateContentView() {
        return R.layout.frag_enter_tainment_detail;
    }
