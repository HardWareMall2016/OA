...
public abstract class ABaseTabFragment<T> extends APullToRefreshListFragment<T> {
    ...
    protected int getTabNormalTextColor(){
        return 0xff999999;
    }

    protected int getTabSelectedBackgroundRes(){
        return R.drawable.bg_main_color_underline;
    }

    protected int getTabNormalBackgroundRes(){
    ...
    private void refreshTabViews() {
        ...
        for (int i = 0; i < mTabList.size(); i++) {
            ...
            mainTab.tabView.setBackgroundResource(getTabNormalBackgroundRes());
            mainTab.tabView.setTextColor(getTabNormalTextColor());
        }
        selMainTab.tabView.setBackgroundResource(getTabSelectedBackgroundRes());
        selMainTab.tabView.setTextColor(getTabSelectedTextColor());
        //不管是不是最后更新到这个
        ...
        if (mSubTabContent!=null&&selMainTab.childTabList.size() > 0) {
            ...
            for (int subIndex = 0; subIndex < selMainTab.childTabList.size(); subIndex++) {
                ...
                subTab.tabView.setBackgroundResource(getTabNormalBackgroundRes());
                subTab.tabView.setTextColor(getTabNormalTextColor());
            ...
            selSubTab.tabView.setBackgroundResource(getTabSelectedBackgroundRes());
            selSubTab.tabView.setTextColor(getTabSelectedTextColor());
    ...
    protected int getCurMainTab(){
        return mCurMainTabCode;
    }
