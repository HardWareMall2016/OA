...
import com.android.wandong.ui.fragment.work.ReportFormListFragment;
...
public class WorkTabUtils {
    ...
    public ArrayList<WorkMain.WorkCategoryItem> generateTabs(){
        ...
        if(workMenu.getMenuByEntityName(NEW_WORKREPORT)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_NOTICEINFO)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_SHARE)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_CONTRACT)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_TENDERAUTHORIZATION)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_RECEPTION)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_ENTERTAIN)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_CAMPAIGN)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_TRAVELCOST)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_SPECIAL_PAYMENT)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_ENTERTAINCOST)!=null) {
            item = new WorkMain.WorkCategoryItem();
        ...
        if(workMenu.getMenuByEntityName(NEW_CAMPAIGNCOST)!=null) {
            item = new WorkMain.WorkCategoryItem();
