...
import com.android.wandong.beans.EntertainReimburseCreateListResponseBean;
...
public class EntertainmentReimbursementCreateFragment extends APullToRefreshListFragment<EntertainmentReimbursementCreateFragment.AccountInfo> {
    ...
    protected void requestData(RefreshMode mode) {
        ...
        startFormRequest(ApiUrls.ENTERTAIN_APPLY_LIST, requestParams, new PagingTask<EntertainReimburseCreateListResponseBean>(mode) {
            @Override
            public EntertainReimburseCreateListResponseBean parseResponseToResult(String content) {
                return Tools.parseJson(content, EntertainReimburseCreateListResponseBean.class);
            }

            @Override
            public String verifyResponseResult(EntertainReimburseCreateListResponseBean result) {
                return Tools.verifyResponseResult(result);
            }

            @Override
            protected List<AccountInfo> parseResult(EntertainReimburseCreateListResponseBean baseResponseBean) {
